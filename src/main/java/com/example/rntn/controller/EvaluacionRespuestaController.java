...
/**
 * Controller REST para gestión de respuestas de evaluación con análisis de sentimientos
 * ⭐ ENDPOINT PRINCIPAL - Integración RNTN + MySQL
 */
@RestController
@RequestMapping("/api/v1/evaluaciones/respuestas")
@RequiredArgsConstructor
@Slf4j
@Tag(name = "Evaluaciones Respuestas", description = "API para gestión de respuestas de evaluación con análisis de sentimientos RNTN")
public class EvaluacionRespuestaController {
    ...
    public ResponseEntity<Map<String, Object>> obtenerAnalisisAgregado(
        ...
        log.info("GET /api/v1/evaluaciones/respuestas/analisis-agregado - Preguntas: {}", preguntaIds);
